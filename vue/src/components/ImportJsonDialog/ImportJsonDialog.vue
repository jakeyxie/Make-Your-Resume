<template>
<!--
:show-close设置右上角关闭按钮不可见
:close-on-click-modal="false"设置点击对话框外部（即遮罩部分）时不关闭对话框。
append-to-body该属性表示将对话框插入到 body 元素中，这样可以避免一些样式上的冲突。
-->
  <el-dialog
...
<!--  autofocus自动对焦 indent-with-tab通过tab缩进 extensions提供编辑器拓展功能   -->
      <codemirror
        v-model="code"
